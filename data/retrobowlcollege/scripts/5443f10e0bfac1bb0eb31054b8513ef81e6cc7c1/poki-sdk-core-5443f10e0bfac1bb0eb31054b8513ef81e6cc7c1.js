              ...
              return (
                ...
                new Promise(function (n) {
                  t.monetization.init(
                    ...
                    ("inspector-uploads.poki-user-content.com" === window.location.hostname || document.referrer.startsWith("")) && t.setupInspector(),
              ...
              return o(this, void 0, void 0, function () {
                ...
                return r(this, function (n) {
                  switch (n.label) {
                    ...
                    case 1:
                      return (t.cookies = n.sent()), (t.p4d_game_id = i.Z.gameID), (t.user_id = s), (e = t), window.fetch("", { method: "post", body: JSON.stringify(e) }).catch(), [3, 3];
                    case 2:
                      return n.sent(), [3, 3];
                    case 3:
                      return [2];
                ...
                (r = o.map(function (o) {
                  return $(a, void 0, void 0, function () {
                    ...
                    return ee(this, function (a) {
                      return (
                        (r = o.replace(i, "$1")).startsWith("") || (r = new URL(r, e.url).href),
                        [
                          2,
          ...
          we = function (e) {
            return me(void 0, void 0, void 0, function () {
              ...
              return ve(this, function (r) {
                switch (r.label) {
                  case 0:
                    return (t = e.screenshot), "", (n = ""), [4, fetch("", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ data: t }) })];
                  case 1:
                    (i = r.sent()), (r.label = 2);
                  case 2:
      ...
      902: (e, t, n) => {
        ...
        const s = function (e) {
          ...
          if ("undefined" != typeof window && "undefined" != typeof fetch) {
            ...
            i.Z.debug ? console.log("PokiAdServer Tracking: ", d) : fetch("", { method: "POST", mode: "no-cors", body: JSON.stringify(d) });
          }
        };
      },
      888: (e, t, n) => {
                ...
                return Qe(this, function (A) {
                  switch (A.label) {
                    ...
                    case 2:
                      (s = A.sent()), (A.label = 3);
                    case 3:
                      if (((n = o.apply(i, [((l.d = [((u.v = a.apply(r, [((p.json = s), (p.body = JSON.stringify({ href: "".concat(window.location.protocol, "//").concat(window.location.host).concat(t).concat(window.location.search) })), (p.name = e.name), (p.message = e.message), p)])), u)]), l)])), (d = ""), navigator.sendBeacon)) navigator.sendBeacon(d, n);
                      else
                        try {
          ...
          return $e(this, function (s) {
            switch (s.label) {
              case 0:
                ...
                s.label = 1;
              case 1:
                return s.trys.push([1, 4, , 5]), [4, fetch("", { method: "GET", headers: { "Content-Type": "application/json" } })];
              case 2:
          ...
          (this.slotMap = new Map()),
            ...
            (this.requestHouseAd = function (i, o) {
              ...
              (0, D.Z)(tt(tt({}, r), { event: "request" })),
                fetch("".concat(i.width, "x").concat(i.height, "?game_id=").concat(n.Z.gameID, "&site=").concat(n.Z.siteID))
                  .then(function (e) {
                    return e.json();
                  })
                  .then(function (n) {
                  ...
                  switch (Z.label) {
                    ...
                    case 2:
                      return (
                        w.push((0, b.Z)("")),
                        h || w.push((0, b.Z)("")),
                        n.Z.familyFriendly || n.Z.nonPersonalized ? (n.Z.familyFriendly && this.display.enforceFamilyFriendlyFlow(), (0, n.w)("nonPersonalized", "true"), this.display.enforceNonPersonalized()) : w.push((0, b.Z)(""), (0, b.Z)("")),
