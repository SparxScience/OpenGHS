(() => {
					...
					if (i) {
						...
						s.noConflict = function() {
							...
							function m(e) {
								...
								for (var t, i, n, a = /^\s*at (.*?) ?\(((?:\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i, s = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)((?:\[native).*?|[^@]*bundle)(?::(\d+))?(?::(\d+))?\s*$/i, d = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:):.*?):(\d+)(?::(\d+))?\)?\s*$/i, A = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i, u = /\((\S*)(?::(\d+))(?::(\d+))\)/, h = e.stack.split("\n"), m = [], g = /^(.*) is undefined$/.exec(e.message), f = 0, v = h.length; f < v; ++f) {
									if (i = a.exec(h[f])) {
							...
							function v(t, a) {
								...
								try {
									if (s = function(e) {
											...
											var a, s = /^\s*Line (\d+) of linked script ((?:)\S+)(?:: in function (\S+))?\s*$/i,
												c = /^\s*Line (\d+) of inline#(\d+) script in ((?:)\S+)(?:: in function (\S+))?\s*$/i,
	...
	i.n = e => {
							...
							if (s) {
								...
								if (1 !== d && (!k || !k.videoCacheKey || k.cpm < B(o))) {
									...
									"ninja.io" === (null === (g = null === window || void 0 === window ? void 0 : window.location) || void 0 === g ? void 0 : g.hostname) && (S = function(e) {
										...
										cpm: S,
										vast: "" + ("" === $e.gameId ? "" : "?game_id=" + $e.gameId),
										bidder: "poki",
										videoCacheKey: "poki"
									}
								}
		...
		function $() {
			...
			return "yes" === I("poki-ad-server") ? (console.log("DEBUG: Only running Poki-ad-server"), !0) : "localhost" !== t && "" !== t && !t.endsWith("") && ("" === t ? Math.random() <= .5 : "" === t ? Math.random() <= .05 : "" === t)
		}
		var ee = function() {
			function e(e, t) {
					...
					return Ze(this, (function(n) {
						switch (n.label) {
							case 0:
								...
								n.label = 1;
							case 1:
								return n.trys.push([1, 4, , 5]), [4, fetch("")];
							case 2:
		...
		var Je = function() {
			...
			et = function() {
				...
				return e.prototype.init = function(e) {
					...
					var T = [k(), S()],
						_ = Ye(Ye([], T, !0), [Ge()], !1);
					this.isBot || (_.push(Pe(""), Pe("")), (I("url_referrer") || "").includes("") ? (e.prebidAvailable = !1, e.childDirected = !0, e.nonPersonalized = !0, this.IGD.enforceChildSafety()) : _.push(Pe(""), Pe("")));
					...
					if (this.autoStartOnReady = !1 !== i, d && this.registerHandler("onFinish", d), c && this.registerHandler("onStart", c), this.isBot) d && d({});
						...
						if (this.sdkImaError) a.dispatchEvent(n.ads.error, {
							...
							message: "No USP detected, please contact FUCK YOU POKI ON fuckyoupoki.42web.io for more information"
						});
						else a.dispatchEvent(n.ads.error, {
							message: "No TCFv2 CMP detected, please contact FUCK YOU POKI ON fuckyoupoki.42web.io for more information"
						});
